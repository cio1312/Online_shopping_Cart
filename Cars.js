...
import Marketlist from "./Cars.json";
      ...
      return (
        <div>
          <Helmet
            bodyAttributes={{
              style:
                'background-image : url("https://i.pinimg.com/originals/0e/cc/ec/0eccec9f682ab9979c793352a3efdda4.jpg");'
            }}
          />
          <p id="headings">Lets Drive </p>
